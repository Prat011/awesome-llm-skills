...
- [A.S.K. — Agent Skills Kernel](https://github.com/srmbsrg/ask-kernel) - Versioned, composable library of AI agent capabilities for Claude Code and compatible runtimes. Define skills once in SKILL.md files; ships as a plugin with 65+ cross-domain skills (finance, engineering, marketing, ops, data). *By [@srmbsrg](https://github.com/srmbsrg)*
