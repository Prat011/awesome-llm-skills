...
- [okf-skills](https://github.com/scaccogatto/okf-skills) - Teaches coding agents to author, maintain, validate, and visualize Open Knowledge Format (OKF) bundles: portable markdown knowledge that humans and agents both read. Ships as portable agent skills (Claude Code, Cursor, Codex, and other SKILL.md-compatible agents) plus a GitHub Action for CI gating; includes a deterministic conformance checker and an interactive graph renderer. *By [@scaccogatto](https://github.com/scaccogatto)*
