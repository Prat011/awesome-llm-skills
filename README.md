...
- [FP (Finish with Proof)](https://github.com/MiaoY0uShan/FP) - Portable execution protocol for coding agents. Risk-matched routing (Small/Medium/Vague/Large), evidence-first diagnosis, on-demand profiles. 77 lines, 3 core rules. 1,416 API calls benchmarked — v-final champion on GPT-5.6-Sol (3.57) and DeepSeek-v4-Pro (3.14).
