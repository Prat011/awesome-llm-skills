...
- [falsify](https://github.com/263311487-ux/falsify) - Scientific thinking protocol for AI agents (Axiomatize → Hypothesize → Adversarialize → Verify → Converge). Stops agents from giving confident answers they cannot falsify; ships 28 eval cases + external dogfood validation. Works with Claude Code, Codex, Cursor, Gemini CLI and 20+ agents. Install: `npx falsify-skill`
