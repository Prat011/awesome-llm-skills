...
- [SpecFusion](https://github.com/wxkingstar/SpecFusion) - Search 15 Chinese open platform API docs (WeChat Work, Feishu, DingTalk, Taobao, Xiaohongshu, Douyin, WeChat Pay, Alipay, JD, SHEIN, Dewu) directly in your AI coding tool. 26,840+ docs with Chinese FTS5 search, zero config.
