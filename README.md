...
- [skillcraft](https://github.com/dimanovikov/skillcraft) - Linter + sync CLI for AI agent-config files (SKILL.md, CLAUDE.md, AGENTS.md, .cursor/rules, .claude/rules, copilot-instructions). Pluggable rules, one AGENTS.md canonical source generating and drift-checking every format, SARIF for CI. *By [@dimanovikov](https://github.com/dimanovikov)*
