...
- [Schema-Guided Reasoning for Pydantic](https://github.com/feodal01/schema-guided-reasoning-pydantic) - Apply SGR (Schema-Guided Reasoning) with Pydantic to enforce structured output in LLM APIs: branch locks, reasoning-first field order, and Cascade/Routing/Cycle patterns. Per-provider notes for OpenAI and Gemini.
