...
- [Tree Ring Memory](./tree-ring-memory/) - Guides agents to use lifecycle-aware local memory for recall, evidence, audit, forgetting, and project bridge guidance. *By [@TerminallyLazy](https://github.com/TerminallyLazy)*
