...
- [Codex Skin Pack Installer](https://github.com/ChannelerH/codex-skin-packs/tree/main/codex-skin-pack-installer) - Stages verified Codex Desktop skin packs from GitHub releases, validates files, and keeps restore guidance. *By [@ChannelerH](https://github.com/ChannelerH)*
