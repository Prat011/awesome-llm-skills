...
- [Perseus](https://github.com/tcconnally/perseus) - Cross-assistant live context engine. Resolves `@query`, `@services`, `@waypoint`, and 19 more directives into `CLAUDE.md`, `AGENTS.md`, `.cursorrules`, `.hermes.md`, or whatever context file your AI agent reads at session start. MCP server façade exposes 13 directives as tools. MIT, ~600 tests. *By [@tcconnally](https://github.com/tcconnally)*
