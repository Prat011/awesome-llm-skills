...
- [RunAPI CLI Skill](https://github.com/runapi-ai/cli-skill) - Helps Claude Code, Codex, Gemini CLI, Cursor, and other agents use the RunAPI CLI to generate AI images, videos, and music/audio, plus run other model API jobs.
