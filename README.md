...
- [Crew](https://github.com/Honorboxx/crew) - Three Claude Code subagents for code review, debugging, and planning, plus three skills for task scoping, verify-before-done, and git hygiene. *By [@Honorboxx](https://github.com/Honorboxx)*
