...
- [Emdash Skills](https://github.com/megabytespace/claude-skills) - 14-category autonomous product-building OS for Claude Code, Codex, and 30+ AI coding tools. 94 reference docs, 18 agents. Ships SaaS on CF Workers + Hono + Angular + D1 + Stripe from one-line prompts. *By [@megabytespace](https://github.com/megabytespace)*
