...
- [RunAPI CLI Skill](https://github.com/runapi-ai/cli-skill) - Helps Claude Code, Codex, Gemini CLI, Cursor, and other agents install and use the RunAPI CLI for model API jobs.
