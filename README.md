...
- [Mantra](https://mantra.gonewx.com) - Time-travel debugger for AI coding sessions — replay, inspect, and understand what happened during any coding session. Releases at [mantra-releases](https://github.com/mantra-hq/mantra-releases). *By [@mantra-hq](https://github.com/mantra-hq)*
