...
- [Stitch Design Local](https://github.com/yshishenya/codex-stitch-local) - Cross-agent Stitch UI generation and iteration skill bundle for Codex, Claude Code, and OpenClaw with local HTML and screenshot exports. *By [@yshishenya](https://github.com/yshishenya)*
