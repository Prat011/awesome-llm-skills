...
- [skillcraft](https://github.com/cloudroad-io/skillcraft) - Linter + sync CLI for AI agent-config files (SKILL.md, CLAUDE.md, AGENTS.md, .cursor/rules, .claude/rules, copilot-instructions). Pluggable rules, one AGENTS.md canonical source generating and drift-checking every format, SARIF for CI. *By [@cloudroad-io](https://github.com/cloudroad-io)*
