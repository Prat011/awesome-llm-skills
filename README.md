...
- [RunAPI CLI Skill](https://github.com/runapi-ai/cli-skill) - Helps Claude Code, Codex, Gemini CLI, Cursor, and other agents use the RunAPI CLI for AI image, video, music, audio, and other model API jobs.
