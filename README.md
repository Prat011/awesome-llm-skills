...
- [terraform-skill](https://github.com/antonbabenko/terraform-skill) - Terraform and OpenTofu patterns for AI agents: modules, state management, testing, CI/CD, and security scanning. *By [@antonbabenko](https://github.com/antonbabenko)*
