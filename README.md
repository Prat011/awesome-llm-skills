...
- [KubeStellar Console](https://github.com/kubestellar/console) - Multi-cluster Kubernetes dashboard with AI-powered operations via kc-agent (MCP server). Manages clusters, policies, and CNCF project integrations across edge and cloud. Ships with CLAUDE.md, AGENTS.md, and built-in agent skills for performance testing, cache compliance, and CI debugging. *By [@kubestellar](https://github.com/kubestellar)*
