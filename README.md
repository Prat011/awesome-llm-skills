...
- [eval-skills](https://github.com/latitude-dev/eval-skills) - 9 Claude Code agent skills covering the full LLM eval workflow: annotate production logs, discover failure patterns, build and validate LLM-as-judge prompts, curate golden datasets, and run regression tests before every prompt change. *By [@latitude-dev](https://github.com/latitude-dev)*
