...
- [Codex Profile Switching](./codex-profile-switching/) - Helps set up, inspect, switch, and troubleshoot Codex CLI/Desktop profiles with isolated `CODEX_HOME` directories. *By [@Ducksss](https://github.com/Ducksss)*
