...
- [CiteGuard](https://github.com/larrylot/citeguard) - Local CLI + agent skill that verifies citations in deep-research Markdown (dead links, title bait, claim–source overlap). *By [@larrylot](https://github.com/larrylot)*
