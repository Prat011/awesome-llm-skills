...
- [LinkedIn](./linkedin/) - General-purpose LinkedIn automation via [Linked API](https://linkedapi.io): fetch profiles, search people and companies, send messages, manage connections, create posts, and more. Supports Sales Navigator and custom workflows.
