...
- [RouterBase Model Gateway](./routerbase-model-gateway/) - Plan OpenAI-compatible API integration, model routing, and media generation workflows using [routerbase](https://routerbase.com/). *By [@zenlee123](https://github.com/zenlee123)*
