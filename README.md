...
- [agent-manager-skill](https://github.com/fractalmind-ai/agent-manager-skill) - tmux + Python agent lifecycle manager for local CLI agents (start/stop/monitor/assign + cron scheduling).
