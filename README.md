...
- [Video Router](./video-router/) - Routes a video brief to generation, composition, editing, or an end-to-end workflow before production begins. Inspired by [OrkasVideoStudio](https://github.com/Orkas-AI/Orkas-VideoStudio).
