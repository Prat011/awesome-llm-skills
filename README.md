...
- [BrowserAct](./browser-act/) - Automates authenticated, JavaScript-rendered browser workflows with extraction, screenshots, parallel sessions, and human handoff. *By [BrowserAct](https://github.com/browser-act)*
