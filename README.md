...
- [Staff Engineer Mode](https://github.com/sirmarkz/staff-engineer-mode) - Major-outage lessons for engineering work across architecture, reliability, security, delivery, and operations. One router skill loads 54 specialist references. Works with Claude Code, Codex, Cursor, OpenCode, Copilot, and Gemini. *By [@sirmarkz](https://github.com/sirmarkz)*
