...
- [Ontoly Software Graph](./ontoly-software-graph/) - Uses Ontoly's deterministic Software Graph and MCP server for codebase architecture, request tracing, dependency analysis, and impact analysis. *By [@0xsarwagya](https://github.com/0xsarwagya)*
