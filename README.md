...
- [claude-learn](https://github.com/OutcomeFocusAi/claude-learn) - Self-improving behavioral rules plugin for Claude Code. Closed feedback loop with scored rules, automated decay, community playbook sharing, and collective intelligence. *By [@OutcomeFocusAi](https://github.com/OutcomeFocusAi)*
