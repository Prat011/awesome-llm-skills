...
- [agent-skill-groups](https://github.com/go165/agent-skill-groups) - Scenario-based skill group and profile manager for Codex, Claude Code, OpenCode, and Agent Skills.
