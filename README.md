...
- [Ditto](https://github.com/ohad6k/ditto) - Mines local Claude Code and Codex session history into private, evidence-backed work, design, and writing profiles that agents load as skills. *By [@ohad6k](https://github.com/ohad6k)*
