...
- [Find Products by Intent](./find-products-by-intent/) - Finds evidence-backed product matches in Mydentify for a person's desired outcome instead of relying on a product category.
