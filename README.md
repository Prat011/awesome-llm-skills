...
- [Engineering Loop](https://github.com/Phelan164/codex-howto/tree/main/skills/engineering-loop) - Runs a scoped implementation loop through focused checks, required checks, findings-first review, and evidence handoff, with a measurement protocol for controlled comparisons. *By [@Phelan164](https://github.com/Phelan164)*
